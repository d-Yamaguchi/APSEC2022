...
public java.util.ArrayList<java.lang.String> getUserLog(java.lang.String name, int id) {
    ...
    result.add(c.getConfigurationSection(sortedKeys.get(id - 1) + ".items"));
    ...
    java.lang.String _CVAR3 = name + _CVAR2;
    // ファイルからロード（なければnullを返して終了）
    java.io.File file = new java.io.File(_CVAR1, _CVAR3);
    java.io.File _CVAR4 = file;
    org.bukkit.configuration.file.YamlConfiguration config = org.bukkit.configuration.file.YamlConfiguration.loadConfiguration(_CVAR4);
    java.lang.String _CVAR6 = ".armors";
