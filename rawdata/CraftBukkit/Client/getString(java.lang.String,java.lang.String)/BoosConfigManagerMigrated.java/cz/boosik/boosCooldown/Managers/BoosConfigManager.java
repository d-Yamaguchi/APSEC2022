...
public class BoosConfigManager {
    ...
    public static java.lang.String getCancelWarmupOnSneakMessage() {
        return cz.boosik.boosCooldown.Managers.BoosConfigManager.conf.getString("options.messages.warmup_cancelled_by_sneak", "&6Warm-ups have been cancelled due to sneaking.&f");
    }
