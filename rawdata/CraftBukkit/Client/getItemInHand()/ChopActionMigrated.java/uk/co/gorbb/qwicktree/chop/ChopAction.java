...
public class ChopAction {
    ...
    private int calculateUnbreaking(int damageAmt) {
        int unbreakingLevel = player.getItemInHand().getEnchantmentLevel(org.bukkit.enchantments.Enchantment.DURABILITY);
    ...
    private int getLeafReach() {
        ...
        if (type == uk.co.gorbb.qwicktree.tree.info.TreeType.OAK)
