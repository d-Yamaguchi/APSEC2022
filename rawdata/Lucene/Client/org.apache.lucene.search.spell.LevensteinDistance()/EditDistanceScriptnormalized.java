private float getDistance(java.lang.String target, java.lang.String other) {
    ...
    if ("levenstein".equals(algo)) {
        org.apache.lucene.search.spell.LevensteinDistance _CVAR0 = ((org.apache.lucene.search.spell.LevensteinDistance) (new org.apache.lucene.search.spell.LevensteinDistance()));
        builder = _CVAR0;
