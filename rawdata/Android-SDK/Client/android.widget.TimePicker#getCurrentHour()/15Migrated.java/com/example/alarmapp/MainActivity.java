    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        alarm.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                ...
                calendar.set(timePicker.getHour(), timePicker.getCurrentMinute(), 0);
                android.widget.Toast.makeText(MainActivity.this, (("Alarm set at :" + timePicker.getHour()) + ":") + timePicker.getCurrentMinute(), android.widget.Toast.LENGTH_SHORT).show();
                ...
                java.lang.String ct = (("Alarm set at :" + timePicker.getHour()) + ":") + timePicker.getCurrentMinute();
                timetv.setText(ct);
            }
        });
    }
