...
protected void onCreate(android.os.Bundle savedInstanceState) {
    ...
    if (id == (-1)) {
        ...
        _CVAR0.setHours(_CVAR2);
        android.widget.TimePicker _CVAR3 = timePicker;
        java.lang.Integer _CVAR4 = _CVAR3.getCurrentHour();
        java.lang.String _CVAR5 = (((((datePicker.getYear() + "/") + (datePicker.getMonth() + 1)) + "/") + datePicker.getDayOfMonth()) + " ") + _CVAR4;
        java.lang.String _CVAR6 = _CVAR5 + ":";
        java.lang.String date = _CVAR6 + timePicker.getCurrentMinute();
    ...
    java.lang.String _CVAR9 = timePicker.getCurrentHour() + _CVAR8;
    android.widget.Button _CVAR7 = openTimeButton;
    java.lang.String _CVAR10 = _CVAR9 + timePicker.getCurrentMinute();
    _CVAR7.setText(_CVAR10);
    ...
    android.widget.Button _CVAR11 = timeButton;
    ...
    android.widget.Button _CVAR13 = addButton;
    android.view.View.OnClickListener _CVAR14 = new android.view.View.OnClickListener() {
        @java.lang.Override
        public void onClick(android.view.View v) {
    ...
    _CVAR13.setOnClickListener(_CVAR14);
}