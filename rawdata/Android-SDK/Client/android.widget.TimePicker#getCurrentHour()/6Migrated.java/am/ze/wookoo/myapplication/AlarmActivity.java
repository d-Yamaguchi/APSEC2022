    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        save_btn.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                ...
                if () {
                    data = java.lang.String.format(" Alarm %d : %02d PM", alarm_timepicker.getCurrentHour() - 12, alarm_timepicker.getCurrentMinute());
                } else if () {
                    data = java.lang.String.format(" Alarm %d : %02d PM", alarm_timepicker.getHour(), alarm_timepicker.getCurrentMinute());
                } else if () {
                    data = java.lang.String.format(" Alarm %d : %02d AM", 12, alarm_timepicker.getCurrentMinute());
                } else {
                    data = java.lang.String.format(" Alarm %d : %02d AM", alarm_timepicker.getHour(), alarm_timepicker.getCurrentMinute());
                }
