...
public class Sceduletask extends android.support.v7.app.AppCompatActivity {
    ...
    public void SetAlarm(android.view.View view) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 23) {
            ...
            calendar.set(calendar.get(java.util.Calendar.YEAR), calendar.get(java.util.Calendar.MONTH), calendar.get(java.util.Calendar.DAY_OF_MONTH), timePicker.getHour(), timePicker.getCurrentMinute(), 0);
