...
public class TimePreference extends android.preference.DialogPreference {
    ...
    public void onBindDialogView(android.view.View view) {
        ...
        timePicker.setCurrentHour(getSharedPreferences().getInt(getKey() + ".hour", com.jim.pocketaccounter.utils.TimePreference.DEFAULT_HOUR));
        timePicker.setCurrentMinute(getSharedPreferences().getInt(getKey() + ".minute", com.jim.pocketaccounter.utils.TimePreference.DEFAULT_MINUTE));
