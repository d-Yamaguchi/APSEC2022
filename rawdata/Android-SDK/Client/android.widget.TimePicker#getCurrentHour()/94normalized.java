...
public void onClick(android.view.View v) {
    ...
    if (alarmTitle.isEmpty()) {
        ...
        java.util.concurrent.TimeUnit _CVAR5 = java.util.concurrent.TimeUnit.HOURS;
        ...
        long _CVAR9 = _CVAR8 + java.util.concurrent.TimeUnit.MINUTES.toSeconds(timePicker.getCurrentMinute());
