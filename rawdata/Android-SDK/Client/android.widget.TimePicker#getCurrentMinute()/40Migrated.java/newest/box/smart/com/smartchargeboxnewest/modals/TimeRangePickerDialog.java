...
public class TimeRangePickerDialog extends android.support.v4.app.DialogFragment implements android.view.View.OnClickListener , android.widget.TabHost.OnTabChangeListener {
    ...
    public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
        ...
        startCalendar.set(startYear, startMonth - 1, startDay, startTimePicker.getCurrentHour(), startTimePicker.getMinute());
        ...
        endCalendar.set(endYear, endMonth - 1, endDay, endTimePicker.getCurrentHour(), startTimePicker.getMinute());
