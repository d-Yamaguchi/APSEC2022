...
public void onClick(android.view.View v) {
    ...
    if (workload.trim().length() == 0) {
        ...
        android.widget.TimePicker _CVAR0 = timepickerIn;
        int inMin = _CVAR0.getCurrentMinute();
        int outHour = timepickerOut.getCurrentHour() * 60;
        android.widget.TimePicker _CVAR1 = timepickerOut;
        int outMin = _CVAR1.getCurrentMinute();
        int in2Hour = timepickerIn2.getCurrentHour() * 60;
        android.widget.TimePicker _CVAR2 = timepickerIn2;
        int in2Min = _CVAR2.getCurrentMinute();
        int out2Hour;
        int out2Min;
