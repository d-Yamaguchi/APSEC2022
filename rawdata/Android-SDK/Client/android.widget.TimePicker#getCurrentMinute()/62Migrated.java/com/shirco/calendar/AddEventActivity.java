...
public class AddEventActivity extends android.support.v7.app.AppCompatActivity {
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        if (id == (-1)) {
            ...
            tmp.setMinutes(timePicker.getMinute());
            tmp.setHours(timePicker.getCurrentHour());
            java.lang.String date = (((((((datePicker.getYear() + "/") + (datePicker.getMonth() + 1)) + "/") + datePicker.getDayOfMonth()) + " ") + timePicker.getCurrentHour()) + ":") + timePicker.getMinute();
        ...
        openTimeButton.setText((timePicker.getCurrentHour() + ":") + timePicker.getMinute());
