        ...
        if (((i.hasExtra("title") && i.hasExtra("hour")) && i.hasExtra("minute")) && i.hasExtra("position")) {
            ...
            public void onClick(android.view.View v) {
                ...
                if (alarmTitle.isEmpty()) {
                    ...
                    long milliseconds = java.util.concurrent.TimeUnit.SECONDS.toMillis(java.util.concurrent.TimeUnit.HOURS.toSeconds(timePicker.getCurrentHour()) + java.util.concurrent.TimeUnit.MINUTES.toSeconds(timePicker.getMinute()));
                    ...
                    if (update) {
                        ...
                        o.putExtra("Min", timePicker.getMinute());
                        setResult(101, o);
                        finish();
                    } else {
                        ...
                        f.putExtra("Min", timePicker.getMinute());
