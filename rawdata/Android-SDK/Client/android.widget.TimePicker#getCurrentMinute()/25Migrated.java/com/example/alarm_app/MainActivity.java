    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        alarm.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View view) {
                ...
                cal.set(timepicker.getCurrentHour(), timepicker.getMinute(), 00);
                android.widget.Toast.makeText(MainActivity.this, (("Alarm set at:" + timepicker.getCurrentHour()) + ":") + timepicker.getMinute(), android.widget.Toast.LENGTH_LONG).show();
                ...
                java.lang.String currentTime = (("Alarm Set: " + timepicker.getCurrentHour()) + ":") + timepicker.getMinute();
