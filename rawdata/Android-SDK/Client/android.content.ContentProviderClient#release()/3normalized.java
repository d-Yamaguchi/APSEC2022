private static void checkWidevineClassic(android.content.Context context) {
    ...
    try {
        com.kaltura.playkit.player.MediaSupport.widevineClassic = drmManagerClient.canHandle("", "video/wvm");
        ...
        com.kaltura.playkit.player.MediaSupport.log.e("drmManagerClient.canHandle failed");
        if ((android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) && (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.M)) {
            com.kaltura.playkit.player.MediaSupport.log.w("Assuming WV Classic is supported although canHandle has failed");
            com.kaltura.playkit.player.MediaSupport.widevineClassic = true;
        }
    } finally {
