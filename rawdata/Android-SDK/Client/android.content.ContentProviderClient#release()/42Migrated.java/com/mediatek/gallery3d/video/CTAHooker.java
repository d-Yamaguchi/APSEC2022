...
public class CTAHooker extends com.mediatek.gallery3d.video.MovieHooker {
    private static final java.lang.String TAG = "VP_CTAHooker";
    ...
    public void finishPlayIfNeed() {
        com.mediatek.galleryportable.Log.d(com.mediatek.gallery3d.video.CTAHooker.TAG, "finishPlayIfNeed mIsCtaPlayback = " + mIsCtaPlayback);
        if (mIsCtaPlayback) {
