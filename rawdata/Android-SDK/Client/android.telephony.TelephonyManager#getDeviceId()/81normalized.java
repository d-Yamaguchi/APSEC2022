...
public static java.lang.String getUniqueId(android.content.Context context) {
    ...
    try {
        ...
        if (mTelephony != null) {
            ...
            if () {
                ...
                java.lang.String _CVAR2 = com.shoppin.shopper.utils.UniqueId.TAG;
            ...
            if () {
                android.util.Log.e(com.shoppin.shopper.utils.UniqueId.TAG, "mTelephony.getSimSerialNumber() = " + mTelephony.getSimSerialNumber());
    ...
    try {
        ...
        android.util.Log.e(com.shoppin.shopper.utils.UniqueId.TAG, "androidId = " + androidId);
    } catch (java.lang.Exception e) {
        // TODO Auto-generated catch block
        e.printStackTrace();
    }
    ...
    android.util.Log.e(com.shoppin.shopper.utils.UniqueId.TAG, "uniqueId = " + uniqueId);
    return uniqueId;
}