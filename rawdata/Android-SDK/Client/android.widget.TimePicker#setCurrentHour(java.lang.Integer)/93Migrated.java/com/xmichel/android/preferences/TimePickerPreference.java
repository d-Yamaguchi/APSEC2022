...
public class TimePickerPreference extends android.preference.DialogPreference implements android.widget.TimePicker.OnTimeChangedListener {
    ...
    public void setDefaultValue(java.lang.Object defaultValue) {
        ...
        if (!((java.lang.String) (defaultValue)).matches(com.xmichel.android.preferences.TimePickerPreference.VALIDATION_EXPRESSION)) {
            return;
        }
    ...
    private int getHour() {
        ...
        if ((time == null) || (!time.matches(com.xmichel.android.preferences.TimePickerPreference.VALIDATION_EXPRESSION))) {
            return -1;
        }
