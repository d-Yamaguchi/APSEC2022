...
public class TimePickerPreference extends android.preference.DialogPreference implements android.widget.TimePicker.OnTimeChangedListener {
    ...
    public void onTimeChanged(android.widget.TimePicker view, int hour, int minute) {
        java.lang.String strTime = java.lang.String.format("%d:%02d", hour, minute);
    ...
    public void setDefaultValue(java.lang.Object defaultValue) {
        ...
        if (!((java.lang.String) (defaultValue)).matches(com.jeebook.android.TimePickerPreference.VALIDATION_EXPRESSION)) {
            return;
        }
    ...
    private int getHour() {
        ...
        if ((time == null) || (!time.matches(com.jeebook.android.TimePickerPreference.VALIDATION_EXPRESSION))) {
            return -1;
        }
